...
a soma entre elas e atribua à variável SOMA. A seguir escrever o valor desta
variável.
...
correspondente à soma de A e B. Como todos os problemas, não esqueça de imprimir
